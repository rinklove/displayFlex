			...
			<div id="product-detail">
				...
				<div id="detail">
					...
					<div id="description">
						...
						<div>분류</div>
						<span> <input type="radio" value="snack" name="type">
							스낵 <input type="radio" value="photocard" name="type">
							포토카드 <input type="radio" value="combo" name="type"> 콤보 <br>
							<input type="radio" value="popcorn" name="type"> 팝콘 <input
							type="radio" value="drink" name="type"> 음료
						</span>
					</div>
				</div>
			</div>
