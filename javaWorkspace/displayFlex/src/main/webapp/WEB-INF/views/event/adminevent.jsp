				...
				<div id="product-detail">
					...
					<div id="detail">
						...
						<div id="description">
							<div>이벤트기간</div>
							<div>
								<input style="width: 10em; font-size: 15px;"type="date" id="couponUsageStartDate" name="couponUsageStartDate" value="2023-12-03">
                                <span> to </span>
                                <input style="width: 10em; font-size: 15px;"type="date" id="couponUsageEndDate" name="couponUsageEndDate" value="2023-12-17">
							</div>
                            
							<div>이벤트 내용</div>
							<div>
								<textarea id="productDetail" cols="50" rows="5"
